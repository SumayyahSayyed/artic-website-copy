...
import CEOImage from "../../assets/images/ceo-picture.jpg";
...
const HeroSection = () => {
    ...
    useGSAP(() => {
        if (isImageLoaded) {
            ...
            gsap.from(".hero-section-three", { zIndex: -100, y: -100, duration: 1, ease: 'power1.inOut' });
        }
    ...
    return (
        <div className='herosection-component' data-scroll-section>
            <div data-scroll data-scroll-delay="0.12" data-scroll-speed="6" data-scroll-position="top">
            ...
            <div className='hero-sections'>
                <div className='hero-section-inner' data-scroll data-scroll-delay="0.18" data-scroll-speed="6" data-scroll-position="top">
                    <div className='hero-section-one' style={{ overflow: 'hidden' }}>
                    ...
                    <div style={{ overflow: "hidden" }}>
                        <div className='hero-section-three' data-scroll data-scroll-delay="0.16" data-scroll-speed="6" data-scroll-position="top">
                            <img src={CEOImage} className='ceo-image' alt="" />
                            <div className='ceo-info-section'>
                                <h2>Sumayyah Sayyed</h2>
                ...
                <div >
                    <div className='hero-section-two' data-scroll data-scroll-delay="0.12" data-scroll-speed="6" data-scroll-position="top">
                        ...
                        <div className='hero-details-section'>
                            ...
                            <div>
                                <h2 className='hero-details-heading'>
